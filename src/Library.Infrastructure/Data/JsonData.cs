...
public class JsonData
{
    ...
    public JsonData(IConfiguration configuration)
    {
        ...
        // Try to find Json folder relative to the executable
        ...
        _authorsPath = section["Authors"] ?? Path.Combine(basePath, "Json", "Authors.json");
        _booksPath = section["Books"] ?? Path.Combine(basePath, "Json", "Books.json");
        _bookItemsPath = section["BookItems"] ?? Path.Combine(basePath, "Json", "BookItems.json");
        _patronsPath = section["Patrons"] ?? Path.Combine(basePath, "Json", "Patrons.json");
        _loansPath = section["Loans"] ?? Path.Combine(basePath, "Json", "Loans.json");
    }
